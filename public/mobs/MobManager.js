...
export class MobManager extends EventTarget {
  ...
  spawn(archetype, pos) {
    ...
    const mob = {
      ...
      // INTEGRATION DELTA (Loomfall): expose hitbox dims on the mob record so
      // integration code (player melee raycast vs mob hitboxes) can build the
      // hitbox without reaching into this module's config table.
